...
[Collection("EtablissementFournisseurTestsCollection")]
public class EtablissementFournisseurControllerTests
{
    ...
    private readonly EtablissementFournisseurController _controller;

    public EtablissementFournisseurControllerTests()
    {
        ...
        _controller = new EtablissementFournisseurController(
    ...
    public async Task Get_ReturnsOk_WhenEtablissementExists()
    {
        ...
        _etablissementFournisseurServiceMock.Setup(x => x.GetById(It.IsAny<int>(), false))
    ...
    public async Task GetDataForGrid_ReturnsOk()
    {
        ...
        _etablissementFournisseurServiceMock.Setup(x => x.GetDataForGrid(filter, false))
    ...
    public async Task GetBySiret_ReturnsOk_WhenEtablissementExists()
    {
        // Arrange
        var etablissement = new EtablissementClientDto();
        _etablissementFournisseurServiceMock.Setup(x => x.GetBySiret(It.IsAny<string>(), false))
            .ReturnsAsync(etablissement);
    ...
    public async Task Create_ReturnsOk()
    {
        ...
        _etablissementFournisseurServiceMock.Setup(x => x.Edit(etablissement))
    ...
    public async Task ChangeSiret_ReturnsOk_WhenSuccessful()
    {
        ...
        _etablissementFournisseurServiceMock.Setup(x => x.ChangeSiretAsync(1, request.Siret, false, true, It.IsAny<ContextSession>()))
            .ReturnsAsync(result);
    ...
    {
        // Arrange
        _etablissementFournisseurServiceMock.Setup(x => x.DeleteAsync(It.IsAny<int>(), false, true))
            .ReturnsAsync(true);
    ...
    public async Task GetByCodeKerlog_ReturnsOk_WhenEtablissementExists()
    {
        // Arrange
        var etablissement = new EtablissementClientDto();
        _etablissementFournisseurServiceMock.Setup(x => x.GetByCodeKerlog(It.IsAny<string>(), false))
            .ReturnsAsync(etablissement);
    ...
    [Fact]
    public async Task GetByCodeKerlog_ReturnsNotFound_WhenEtablissementDoesNotExist()
    {
        // Arrange
        _etablissementFournisseurServiceMock.Setup(x => x.GetByCodeKerlog(It.IsAny<string>(), false))
            .ReturnsAsync((EtablissementClientDto?)null);
    ...
    public async Task GetByCodeMkgt_ReturnsOk_WhenEtablissementExists()
    {
        // Arrange
        var etablissement = new EtablissementClientDto();
        _etablissementFournisseurServiceMock.Setup(x => x.GetByCodeMkgt(It.IsAny<string>(), false))
            .ReturnsAsync(etablissement);
    ...
    [Fact]
    public async Task GetByCodeMkgt_ReturnsNotFound_WhenEtablissementDoesNotExist()
    {
        // Arrange
        _etablissementFournisseurServiceMock.Setup(x => x.GetByCodeMkgt(It.IsAny<string>(), false))
            .ReturnsAsync((EtablissementClientDto?)null);
    ...
    public async Task GetByOdooId_ReturnsOk_WhenEtablissementExists()
    {
        // Arrange
        var etablissement = new EtablissementClientDto();
        _etablissementFournisseurServiceMock.Setup(x => x.GetByIdOdoo(It.IsAny<string>(), false))
            .ReturnsAsync(etablissement);
    ...
    [Fact]
    public async Task GetByOdooId_ReturnsNotFound_WhenEtablissementDoesNotExist()
    {
        // Arrange
        _etablissementFournisseurServiceMock.Setup(x => x.GetByIdOdoo(It.IsAny<string>(), false))
            .ReturnsAsync((EtablissementClientDto?)null);
    ...
    public async Task AddBySiret_ReturnsOk_WhenSiretIsValid()
    {
        ...
        _pappersUtilitiesServiceMock.Setup(x => x.CheckSiret(siret))
            .Returns(true);
            _pappersUtilitiesServiceMock.Setup(x => x.CreateEtablissementClientBySiret(siret, false, true, true))
            .ReturnsAsync(etablissement);
    ...
    [Fact]
    public async Task AddBySiret_ReturnsBadRequest_WhenEtablissementAlreadyExists()
    {
        // Arrange
        var siret = "12345678901234";
        var etablissement = new EtablissementClientDto
        ...
        _pappersUtilitiesServiceMock.Setup(x => x.CheckSiret(siret))
            .Returns(true);
        _etablissementFournisseurServiceMock.Setup(x => x.GetBySiret(siret, false))
            .ReturnsAsync(etablissement);
    ...
    {   
        ...
        var siret = "12345678901234";
        _pappersUtilitiesServiceMock.Setup(x => x.CheckSiret(siret))
            .Throws(new HttpRequestException("Erreur webService", null, HttpStatusCode.NotFound));
    ...
    public async Task CreateFromScratch_ReturnsOk()
    {
        ...
        var siret = "12345678901234";
        var etablissement = new EtablissementClientDto();
        _etablissementFournisseurServiceMock.Setup(x => x.CreateFromScratchAsync(siret))
            .ReturnsAsync(etablissement);
    ...
    public async Task DeleteErpCodeAsync_ReturnsOk_WhenSuccessful()
    {
        // Arrange
        var etablissement = new EtablissementClientDto();
        _etablissementFournisseurServiceMock.Setup(x => x.DeleteErpCodeAsync(It.IsAny<int>(), It.IsAny<string>()))
            .ReturnsAsync(etablissement);
