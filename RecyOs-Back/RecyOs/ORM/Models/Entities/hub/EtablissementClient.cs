/** EtablissementClient.cs - Définition du modèle article
 * ======================================================================0
 * Crée par : Benjamin
 * Fichier Crée le : 20/03/2023
 * Fichier Modifié le : 12/04/2023
 * Code développé pour le projet : RecOS.EtablissementClient
 */
...
public class EtablissementClient: TrackedEntity, ICommercialClient
{
    [Column("siret")]
    [MaxLength(14)]
    [Required]
...
#nullable enable
    ...
    public virtual EtablissementFiche? EtablissementFiche { get; set; }

    [Column("no_balance")]
    public bool? NoBalance { get; set; }

    [Column("client_groupe")]
...
#nullable disable
    ...
    [Column("Documents")]
    public virtual ICollection<DocumentPdf> DocumentPdfs { get; set; }
