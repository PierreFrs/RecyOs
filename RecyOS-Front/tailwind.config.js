...
const customPalettes = {
    ...
    recyclageColor: generatePalette("#95c11f"),
    transportColor: generatePalette("#80265f"),
    servicesColor: generatePalette("#5fbfe0"),
    negoceColor: generatePalette("#eb7826"),
};
    ...
    theme: {
        ...
        extend: {
            ...
            animation: {
                ...
                "slide-across": "slideAcross 20s linear infinite",
            },
            colors: {
                gray: colors.slate,
                ...customPalettes,
